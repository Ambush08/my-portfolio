      ...
      <div className="flex flex-col items-center lg:flex-row lg:justify-between lg:items-center max-w-6xl mx-auto mt-35 lg:mt-20 pb-14">
        <div className="flex flex-col items-center justify-center space-y-6 ">
          ...
          <div className='text-heading flex items-center justify-start gap-4 lg:w-full'>
            <Link to="contacts" className="border-1 border-primary px-4 py-3 rounded-lg hover:bg-primary hover:text-white transition-colors duration-300 lg:text-l opacity-80 tracking-normal"
            >
                Connect
                <i class="fa-solid fa-arrow-right"></i>
            </Link>

            <Link to='https://drive.google.com/file/d/1GO9KtS4CauQPBIlH7PLJl7AAqvdGzXEa/view?usp=drive_link' className="border-1 border-github hover:bg-github transition-colors duration-300 py-3 px-4 rounded-lg lg:text-l opacity-80 tracking-normal" target="_blank">
                Download CV
